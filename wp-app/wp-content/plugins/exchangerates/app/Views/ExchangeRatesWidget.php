...
class ExchangeRatesWidget extends \WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'exchange_rates_widget',
            'Курсы валют', // заголовок виджета
            array( 'description' => 'Позволяет вывести курсы валют к белорусскому рублю.' ) // описание
        );
    }
...
<!--        --><?php
    ...
    public function load() {
        add_action( 'widgets_init', function () {
            register_widget( 'ExchangeRatesWidget' );
        });
    }
