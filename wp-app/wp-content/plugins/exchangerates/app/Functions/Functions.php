...
function exchange_rates_scripts() {
    ...
    wp_enqueue_script('exchange-rates-scripts', plugins_url('/js/exchange-rates-scripts.js', __FILE__), array(('jquery')), null, true);

    wp_enqueue_style('exchange-rates-style', plugins_url('/css/exchange-rates-style.css'), null, null);
